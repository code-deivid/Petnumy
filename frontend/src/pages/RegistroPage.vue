...
function validate() {
  ...
  if (password.value !== confirmar.value) return t('auth.validation.passwordMismatch')
  return null
}
  ...
  <div class="auth-page">
    <div class="auth-card card">
      ...
      <div class="auth-form">
        ...
        <div class="name-row">
          <div class="input-group">
            <label class="label" for="nombre">{{ t("auth.register.name") }} *</label>
            <input id="nombre" v-model="nombre" type="text" :placeholder="t('auth.register.namePlaceholder')" class="input" autocomplete="given-name"/>
          </div>
          <div class="input-group">
            <label class="label" for="apellidos">{{ t('auth.register.lastName') }}</label>
            <input id="apellidos" v-model="apellidos" type="text" :placeholder="t('auth.register.lastNamePlaceholder')" class="input" autocomplete="family-name"/>
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            ...
            <input id="email" v-model="email" type="email" :placeholder="t('auth.register.emailPlaceholder')" class="input" autocomplete="email"/>
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            ...
            <input id="password" v-model="password" type="password" :placeholder="t('auth.register.passwordPlaceholder')" class="input" autocomplete="new-password"/>
          </div>
        </div>

        <div class="input-group">
          <label class="label" for="confirmar">{{ t("auth.register.confirmPassword") }} *</label>
          <div class="input-wrapper">
            ...
            <input id="confirmar" v-model="confirmar" type="password" :placeholder="t('auth.newPassword.confirmPlaceholder')" class="input" :class="{ 'input-error': formError?.includes('contraseña') }" autocomplete="new-password" @keyup.enter="handleSubmit"/>
          </div>
      ...
      <p class="auth-footer">
        ...
        <RouterLink :to="{ name: 'login' }" class="auth-footer-link">{{ t('auth.register.loginLink') }}</RouterLink>
      </p>
    </div>
  </div>
</template>
